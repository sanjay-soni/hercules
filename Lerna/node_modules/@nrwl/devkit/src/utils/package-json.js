    ...
    if (Object.keys(deps).length > 0) {
        needsDepsUpdate =
            Object.keys(deps).some((entry) => !packageJsonFile.dependencies[entry]) ||
                Object.keys(deps).some((entry) => !packageJsonFile.devDependencies[entry]);
    }
    if (Object.keys(devDeps).length > 0) {
        needsDevDepsUpdate =
            Object.keys(devDeps).some((entry) => !packageJsonFile.devDependencies[entry]) ||
                Object.keys(devDeps).some((entry) => !packageJsonFile.dependencies[entry]);
    }
